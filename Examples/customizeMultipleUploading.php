...
use Earl\Core\MultiUploader;                                                                     // Use the uploader

$uploader = new MultiUploader('testFile', '/');                                                  // Set the filename and the destination of uploaded files
